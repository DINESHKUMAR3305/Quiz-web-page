const questions = [
    ...
    {
        type: 'radio',
        content: 'Which of the following is not available in earth?',
        options: ['Vibranium', 'Iron', 'Silver', 'Water'],
        answer: 'Vibranium'
    },
    {
        type: 'dropdown',
        content: 'Select the District which is not in tamilnadu Tamilnadu',
    ...
    },
    {
        ...
        options: ['Tamilnadu', 'San fransisco', 'Kerala', 'Washington'],
        answer: ['Tamilnadu', 'Kerala']
    },
    {
        type: 'radio',
        content: 'Which color is not present in rainbow?',
